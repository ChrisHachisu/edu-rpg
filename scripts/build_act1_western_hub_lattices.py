#!/usr/bin/env python3
"""Build deterministic shared-lattice overlays for the Relay 06 western hub."""
...
BATCH = RUNTIME / "western-hub-912-v1"
WORLD_SIZE = 512
...
REGIONS = [
    {
        ...
        "slug": "whispering-approach",
        "x": 512,
        "y": 1216,
        "master": BATCH / "whispering-approach-authored-master-v1.png",
        "composition": BATCH / "composition-refs/whispering-approach-composition-512.png",
        "blendAxis": None,
    },
    {
        "id": "greenhollow-hub-912-v1",
        "slug": "greenhollow-hub",
        "x": 320,
        "y": 1664,
        "master": BATCH / "greenhollow-hub-authored-master-v1.png",
        "composition": BATCH / "composition-refs/greenhollow-hub-composition-512.png",
        "blendAxis": "y+",
    },
    {
        "id": "sunken-approach-912-v1",
        "slug": "sunken-approach",
        "x": 224,
        "y": 2112,
        "master": BATCH / "sunken-approach-authored-master-v1.png",
        "composition": BATCH / "composition-refs/sunken-approach-composition-512.png",
        "blendAxis": "y+",
    },
    {
        "id": "greenhollow-millbrook-912-v1",
        "slug": "greenhollow-millbrook",
        "x": 704,
        "y": 1728,
        "master": BATCH / "greenhollow-millbrook-authored-master-v1.png",
        "composition": BATCH / "composition-refs/greenhollow-millbrook-composition-512.png",
        "blendAxis": "x+",
    },
]
...
METRICS = BATCH / "western-hub-lattice-metrics-v1.json"
CONTACT_SHEET = BATCH / "western-hub-lattice-contact-sheet-v1.png"
SHARED_COMPOSITE = BATCH / "western-hub-shared-composite-912-v1.png"
...
def main() -> None:
    assert (UNION_LEFT, UNION_TOP, UNION_RIGHT, UNION_BOTTOM) == (224, 1216, 1216, 2624)
    assert UNION_SIZE == (1767, 2508)
    ...
    metrics: dict[str, object] = {
        "pipeline": {
            ...
            "paletteReduction": f"western-batch global Pillow MEDIANCUT {PALETTE_COLORS} colors, no dithering",
    ...
    print("ACT 1 WESTERN-HUB LATTICES BUILT: 4 authored regions on one deterministic 57/32 lattice")
