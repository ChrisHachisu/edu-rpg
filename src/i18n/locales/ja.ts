export const jaStrings: Record<string, string> = {
  ...
  'npc.elder.greeting': 'よくきたな ゆうしゃよ。おまえの おばあちゃんは まおうを ふういんしたが ふういんは とけてしまった。ちしきのクリスタルが うばわれたのじゃ！ひがしへ すすんで ダンジョンを みつけ クリスタルを とりもどすのじゃ。とちゅうの オークシェイドのまちで じゅんびするとよいぞ！',
  'npc.elder.quest': 'まずは きりのどうくつへ むかうのじゃ。おおガエルを たおし つぎに すいしょうのどうくつの うみへびに いどむのじゃ！',
  'npc.villager1': 'むらの そとは きをつけて！クリスタルが うばわれてから モンスターが でるようになったんだ。ひがしの オークシェイドのまちを めざすと いいよ。',
  ...
  'npc.scholar': 'ちしきのクリスタルは まなぶものに ちからを あたえる。たたかいでは もんだいに かしこく こたえると おおきな ダメージを あたえられるぞ！',
  'npc.sailor': 'きたの かわの むこうに かげのとうが みえる…きょだいな ドラゴンが すんでいるそうだ。うみへびを たおして はしを ひらくひつようが あるぞ。',
  'npc.wisewoman': 'あの ドラゴンは もとは やさしかった。マラカールの やみに そまってしまったのじゃ。ゆうきで すくってあげて！',
  ...
  'npc.blacksmith': 'おまえの おばあちゃんの つるぎは でんせつだった。つぎのダンジョンの まえに いちばんいい そうびを そろえていけ！',
  'npc.hermit': 'このやまに なんじゅうねんも すんでおる。ひがしの ふぶきのどうくつには いにしえの こおりのワイアームが いる。そのクリスタルが こおりのみちを ひらくのじゃ。',
  'npc.miner': 'むかしは このやまで ほっていたが モンスターに おいだされた。ブリザードベアや こおりのようせいが どうくつに うろついている。きをつけてな！',
  'npc.archaeologist': 'すいぼついせきは こだいぶんめいの なごりじゃ。きょうりょくな リッチが すみついている。そのむこうには かざんのかじば — ものすごい ねつの ばしょが あるぞ！',
  ...
  'npc.veteran': 'ここが さいごのとりで — まおうのしろの まえの さいごの きょてんだ。ようがんちたいの むこうに マラカールの ようさいが ある。さいきょうの そうびを そろえるんじゃぞ！',
  'npc.priestess': 'ぶじに もどってくることを いのっています ゆうしゃさま。まおうは おそろしいですが あつめたクリスタルが ちからを くれます。ひかりが みちびきますように！',
