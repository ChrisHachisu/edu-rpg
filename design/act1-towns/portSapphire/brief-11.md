...
tile (1,1) of a 2x2 grid -- of a small top-down JRPG harbour town, its one gate at the north, buildings around a packed-earth market, and a stone quay along the south with timber piers running out into the bay. It is not a blurry painting to be sharpened and it is not a theme to riff on: it is a map
...
WHAT IS ACTUALLY IN THIS CROP, measured off the image you have been given:
  ...
  - DENSE FOREST CANOPY outside the palisade: individual rounded treetops drawn one by one, each with its own highlight and cast shadow, packed edge to edge so no two are identical. It must never be a flat field of colour -- if this area reads as plain dark green with no trees in it, the tile is wrong: 5.5% of this crop, spanning 84%-100% across and 1%-34% down
  - mid-green GRASS, inside the palisade: 11.1% of this crop, spanning 3%-80% across and 1%-34% down
  - pale PACKED-EARTH STREET AND YARD, the ground the player walks on: 16.1% of this crop, spanning 1%-42% across and 1%-63% down
  - brown BUILDING FACADE, the lower band of a building block: 2.0% of this crop, spanning 54%-81% across and 19%-29% down
  - red-brown ROOF, the upper band of a building block: 3.2% of this crop, spanning 54%-80% across and 11%-22% down
  - the TIMBER PALISADE, a wall of upright logs: 1.1% of this crop, spanning 79%-85% across and 1%-34% down; it meets the top edge at 81%-84%
  - the HARBOUR, open salt water: 60.3% of this crop, spanning 2%-98% across and 36%-99% down; it meets the bottom edge at 0%-100%; left edge at 35%-100%; right edge at 35%-100%
